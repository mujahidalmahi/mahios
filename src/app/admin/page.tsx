      ...
      try {
        ...
        if (projectsRes.data) {
          setData((prev) => ({
            ...
            education: educationRes.data && educationRes.data.length > 0 ? educationRes.data : prev.education,
            achievements: achievementsRes.data && achievementsRes.data.length > 0 ? achievementsRes.data : prev.achievements,
